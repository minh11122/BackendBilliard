...
router.get("/clubs", authenticate, staff.getClubs);
router.patch("/clubs/:id/approve", authenticate, staff.approveClub);
router.patch("/clubs/:id/reject", authenticate, staff.rejectClub);
router.patch("/clubs/:id/lock", authenticate, staff.lockClub);
router.patch("/clubs/:id/unlock", authenticate, staff.unlockClub);
